 ...
 *   Rating: 1
 */
// if x == 0111111... then 0000000...1
// else  000000000000...0
// -1 == 11111111
// ~0 == 11111111...
// x + 1 == 1000000000...
// 2147483646 == 01111111111...110

int
isTmax(int x)
{
	// printf("\n(((2147483647 ^ 1) + 1) ^ (2147483647 + 1)): %d\n",
	// 	(((2147483647 ^ 1) + 1) ^ (2147483647 + 1)));

	// printf("\n(((2147483646 ^ 1) + 1) ^ (2147483646 + 1)): %d\n",
	// 	(((2147483646 ^ 1) + 1) ^ (2147483646 + 1)));

	// printf("\n!(~(((-1 ^ 1) + 1) ^ (x + 1))): %d\n",
	// 	!(~(((-1 ^ 1) + 1) ^ (-1 + 1))));

	// printf("\n(((2147483647 ^ 1) + 1) ^ (((2147483647 ^ 1) + 1) + 1)): %d\n",
	// 	(((2147483647 ^ 1) + 1) ^ (((2147483647 ^ 1) + 1) + 1)));

	// printf("\n(((2147483646 ^ 1) + 1) ^ (((2147483646 ^ 1) + 1) + 1)): %d\n",
	// 	(((2147483646 ^ 1) + 1) ^ (((2147483646 ^ 1) + 1) + 1)));
...
isLessOrEqual(int x, int y)
{
	...
	// if x > 0 && y < 0, then return 0, else return ans.
